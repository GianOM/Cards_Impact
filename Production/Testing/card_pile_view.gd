...
const CARD_MENU_UI_SCENE := preload("res://Testing/card_menu_ui.tscn")
...
#randomized is for view order, 
#e.g. if it is the draw pile, you don't want to show the cards in the exact order you draw them(true)
#otherwise, if it is the discard pile, showing them in the order which they were discarded is nice(false)
