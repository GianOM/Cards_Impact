...
func Host_Button_Apertado():
	#Chama a funcao pra criar um game que esta dentro do Script Lobby_Multiplayer.gd
	LobbyMultiplayer.Create_Multiplayer_Game()
	
	
func Join_Button_Apertado():
	#Chama a funcao pra se juntar a um game que esta dentro do Script Lobby_Multiplayer.gd
